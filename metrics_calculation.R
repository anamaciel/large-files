...
setwd("C:\\Users\\igorw\\Downloads\\metrics_LargeFiles")
root = getwd()
...
write.table(df_all, file = paste0(file_name,".csv"), col.names = TRUE, row.names = FALSE)

#setwd("C:\\Users\\igorw\\Downloads\\metrics_LargeFiles\\angular-5.2.10-parsed")
data_icse2 = read.csv2(paste0(file_name,".csv"), sep=";")
